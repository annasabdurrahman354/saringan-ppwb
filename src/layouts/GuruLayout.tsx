...
import { LogOut, Shield, Menu, Users, BookOpen, Speech } from 'lucide-react';
...
export const GuruLayout = () => {
  ...
  const menuItems = [
    { label: 'Daftar Peserta', path: '/guru/daftar-peserta?action=detail', icon: Users },
    { label: 'Nilai Bacaan', path: '/guru/daftar-peserta?action=nilai-bacaan', icon: BookOpen },
    { label: 'Nilai Penyampaian', path: '/guru/daftar-peserta?action=nilai-penyampaian', icon: Speech },
  ];
              ...
              <Sheet open={mobileMenuOpen} onOpenChange={setMobileMenuOpen}>
                ...
                <SheetContent side="left" className="w-80 p-0">
                  <SheetHeader className="p-6 pb-4">
                    ...
                    <p className="text-left text-sm text-gray-600">Saringan PPWB</p>
                  </SheetHeader>
